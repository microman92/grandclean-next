  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-center">
      <motion.a
        ...
        className="w-11 h-11 bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
      ...
      <motion.a
        ...
        rel="noopener noreferrer"
        aria-label="Facebook"
        className="w-11 h-11 bg-[#1877F2] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
      ...
      <motion.a
        ...
        rel="noopener noreferrer"
        aria-label="Telegram"
        className="w-11 h-11 bg-[#2AABEE] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
